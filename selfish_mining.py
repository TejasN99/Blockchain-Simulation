...
def event_handler(event_list, event, ttx):
    ...
    # Handing a generate_block event would indicate that a node has completed its mining
        ...
        #TOdo:DUPLICATE Case when Adversary publicly releases
            ...
            if not isinstance(src_node,Adversary):
                ...
                if (src_node.mining_on.chain_length-new_block.chain_length <LEAD):
                    ...
                    if (src_node.lead=='0_' or src_node.lead==0):
                        ...
                        new_mining_event = Event(event.execution_time +1, "generate_block", pvt_block1, src_node)
                        ...
                        event_count+=1
                        new_mining_event = Event(event.execution_time +2, "generate_block", pvt_block2, src_node)
                        ...
                        hq.heappush(event_list,(event.execution_time +2, new_mining_event))
